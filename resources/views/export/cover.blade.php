				...
				<div class="col-xs-5">
					...
					<table width="100%">
						<tr>
							...
							<td><span style="font-size:20px;">&nbsp;&nbsp;KERRY&nbsp;&nbsp;</span></td>
						...
						<tr>
							...
							<td height="150" style="border:1px solid black;padding:3px;" colspan="3"><span style="font-size:20px;">{{$exp->export_customernote}}</span></td>
							<td>&nbsp;</td>
						</tr>
					</table>
				</div>
				
				<div class="col-xs-1 text-center" style="border-left: 1px solid black;height: 1000px;"></div>
