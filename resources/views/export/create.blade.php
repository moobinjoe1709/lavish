	...
	<div class="page-header page-header-default">
		...
		<div class="breadcrumb-line">
			<ul class="breadcrumb">
				...
				<li class="active">เพิ่มการขาย</li>
			</ul>
		</div>
	</div>
	<!-- /page header -->
		...
		<!-- 2 columns form -->
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title">เพิ่มการขาย </h5>
							...
							<fieldset>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="customername" id="customername" placeholder="ชื่อลูกค้า" autocomplete="new-password" value="{{$customer->customer_name or ''}}">
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>ที่อยู่ :</label>
											<textarea name="customeraddr" id="customeraddr" rows="2" class="form-control" placeholder="ที่อยู่">{{$customer->customer_detail or ''}}</textarea>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<textarea name="customeraddrdoc" id="customeraddrdoc" rows="2" class="form-control" placeholder="ที่อยู่ส่งของ">{{$customer->customer_detaildoc or ''}}</textarea>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="distric" id="distric" placeholder="เขต/อำเภอ" value="" required>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											<label>จังหวัด :</label>
											<input type="text" class="form-control" name="province" id="province" placeholder="จังหวัด" value="" required>
										</div>
									</div>
								</div>
								@php
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control number" name="customerzipcode" id="customerzipcode" placeholder="รหัสไปรษณีย์" value="" required>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control number" name="customercontel" id="customercontel" placeholder="เบอร์โทรศัพท์" value="{{$customer->customer_tel or ''}}">
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<textarea name="note" id="note" rows="2" class="form-control" placeholder="หมายเหตุ">{{$customer->customer_note or ''}}</textarea>
										</div>
									</div>
									<input type="hidden" name="dateofbirth" id="dateofbirth" value="{{$customer->customer_id or ''}}">
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="select" name="channel" id="channel">
												...
												<option value="Line">Line</option>
												<option value="เฟสบุ๊ค">เฟสบุ๊ค</option>
												<option value="เว็ปไซด์">เว็ปไซด์</option>
												<option value="ช็อปปี้">ช็อปปี้</option>
												<option value="ลาซาด้า">ลาซาด้า</option>
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<div class="col-md-8">
														...
														<input type="hidden" class="form-control" name="sumdiscount" id="sumdiscount" readonly>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-8">
													<div class="radio">
														<label>
															<input type="radio" class="control-success vat" name="vat" id="vat1" value="0" checked="checked">No Vat
														</label>
													</div>
													<div class="radio">
														<label>
															<input type="radio" class="control-success vat" name="vat" id="vat2" value="1">Exclude Vat
														</label>
													</div>
													<div class="radio">
														<label>
															<input type="radio" class="control-success vat" name="vat" id="vat3" value="2">Include Vat
														</label>
													</div>
												</div>
											</div>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-8">
													...
													<input type="hidden" class="form-control" name="sumvat" id="sumvat" readonly>
												</div>
											</div>
										</div>
									</div>
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<div class="col-md-8">
														...
														<input type="hidden" class="form-control" name="sumpayment" id="sumpayment" readonly>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="modal-dialog modal-lg">
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<br></br>
												<div class="row">
													<input type="hidden" id="countcash" value="0">
													<div id="rowcash"></div>
												</div>
												<br>
												<div class="row">
													<input type="hidden" id="countcredit" value="0">
													<div id="rowcredit"></div>
												</div>
												<br>
												<div class="row">
													<input type="hidden" id="countbank" value="0">
													<div id="rowbank"></div>
												</div>
												<br>
												<div class="row">
													<div class="pull-right">
														<table width="100%">
															<tr>
																...
																<td><font size="3" color="green"><span id="txttotal">0.00</span></font></td>
															</tr>
															<tr>
																<td></td>
																<td></td>
																<td width="250px;"><font size="3">เงินสด  :</font></td>
																<td><font size="3"><span id="txtcash">0.00</span></font></td>
															</tr>
															<tr>
																<td></td>
																<td></td>
																<td width="250px;"><font size="3">บัตรเครดิต  :</font></td>
																<td><font size="3"><span id="txtcredit">0.00</span></font></td>
															</tr>
															<tr>
																<td></td>
																<td></td>
																<td width="250px;"><font size="3">โอนผ่านบัญชี  :</font></td>
																<td><font size="3"><span id="txtbank">0.00</span></font></td>
															</tr>
															<tr>
																<td width="250px;" valign="top"><textarea class="form-control" name="comment" id="comment" rows="3" placeholder="หมายเหตุ"></textarea></td>
																...
																<td><font size="3" color="blue"><span id="txtallpayment">0.00</span></font> <input type="hidden" name="cashallpayment" id="cashallpayment" value="0"></td>
															</tr>
														</table>
													</div>
												</div>
