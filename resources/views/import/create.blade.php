	...
	<div class="content">
		<!-- 2 columns form -->
			<div class="panel panel-flat">
				...
				<form id="myForm" method="post" action="{{url('imports_create')}}">
					{{ csrf_field() }}
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="impno" id="impno" placeholder="เลขที่เอกสาร">
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="input-group">
													<input type="text" name="docdateimp" id="docdateimp" placeholder="วันที่" class="form-control datepicker-dates" onkeydown="return false;" autocomplete="off" value="<?php echo date('d/m/Y');?>">
												</div>   
											</div>
										</div>
								...
								<fieldset>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="suppliername" id="suppliername" placeholder="ชื่อผู้ผลิต" autocomplete="off" value="">
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="checkbox" name="check_address" id="check_address"> เลือกที่อยู่
											</div>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label>แฟกซ์ :</label>
												<input type="text" class="form-control number" name="supplier_fax" id="supplier_fax" placeholder="แฟกซ์">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label>อีเมล์ :</label>
												<input type="text" class="form-control" name="supplier_mail" id="supplier_mail" placeholder="อีเมล์">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label>เครดิต :</label>
												<input type="text" class="form-control" name="supplier_credit" id="supplier_credit" placeholder="เครดิต">
											</div>
										</div>
									</div>
									<div class="row">
		...
		bootbox.confirm({
			...
			callback: function (result){
				if(result == true){
					...
					if(row == 0){
						bootbox.alert("คุณยังไม่มีรายการซื้อสินค้า กรุณาตรวจสอบอีกครั้ง!!");
					}else{
						$('#myForm').submit();
					}
				}
