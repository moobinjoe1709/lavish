...
<div class="content-wrapper">
	...
	<div class="page-header page-header-default">
		...
		<div class="breadcrumb-line">
			<ul class="breadcrumb">
				...
				<li class="active">เบิกสินค้า / เพิ่ม </li>
			</ul>
		</div>
	</div>
	<!-- /page header -->
	...
	<div class="content">
		...
		<form id="myForm" method="post" action="{{url('withdraw_create')}}">
			{{ csrf_field() }}
			<div class="row">
				<div class="col-md-12">
					<!-- Vertical form -->
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							<div class="row">
									...
									<fieldset>
										...
										<div class="row">
											...
											<div class="col-md-6">
												...
												<div class="input-group">
													<input type="text" name="docref" id="docref" placeholder="เลขที่อ้างอิง" class="form-control" autocomplete="off" value="">
												</div>
											</div>
								...
								<div class="col-md-6">
									<fieldset>
										<legend class="text-semibold"><i class="icon-info22"></i> รายละเอียด </legend>
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
					...
					$.each(data.results,function(key,item){
						...
						if(find == 0){
							$('#rowdata').append('<tr class="rowbody" id="added_item'+item.id+'">'
								+'<td align="center">'+item.code+'<input type="hidden" class="form-control" name="productid[]" id="productid'+item.id+'" value="'+item.id+'"></td>'
