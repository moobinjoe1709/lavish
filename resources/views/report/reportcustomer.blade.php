                    ...
                    <table style="width:100%;border-collapse: collapse;border:1px solid;">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="height:30px;border-right:1px solid;border-bottom:1px solid;" width="200px">ลูกค้า</th>
								...
								if($product){
									...
									foreach($product as $rs){
										...
										<tr>
											...
											<td class="text-center" style="border-right:1px solid;border-top:1px solid;">{{$rs->export_inv}}</td>
											<td class="text-center" style="border-right:1px solid;border-top:1px solid;">{{$rs->export_date}}</td>
											<td class="text-left" style="padding-left:7px;border-right:1px solid;border-top:1px solid;">{{$rs->export_customername}}</td>
											<td class="text-left" style="padding-left:7px;border-right:1px solid;border-top:1px solid;">{{$rs->product_name}}</td>
											<td class="text-center" style="padding-left:7px;border-right:1px solid;border-top:1px solid;">{{number_format($rs->order_qty)}}</td>
											<td class="text-right" style="border-right:1px solid;border-top:1px solid;padding-right:3px">{{number_format($rs->order_total,2)}}</td>
										</tr>
										@php
										$num++;
									}
						...
						<tfoot>
							<tr>
								<td align="center" style="border-right:1px solid;border-top:1px solid;border-top:1px solid;border-top:1px solid;" colspan="6">รวม</td>
