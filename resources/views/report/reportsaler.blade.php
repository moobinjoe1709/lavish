                    ...
                    <table style="width:100%;border-collapse: collapse;border:1px solid;">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="height:30px;border-right:1px solid;border-bottom:1px solid;" width="200px">เซลล์</th>
								...
								if($sale){
									...
									foreach($sale as $rs){
										...
										<tr>
											...
											<td class="text-left" style="padding-left:7px;border-right:1px solid;border-top:1px solid;">{{$rs->name}}</td>
											<td class="text-left" style="padding-left:7px;border-right:1px solid;border-top:1px solid;">{{$rs->export_customername}}</td>
											<td class="text-right" style="border-right:1px solid;border-top:1px solid;padding-right:3px">{{number_format($rs->export_totalpayment,2)}}</td>
										</tr>
										@php
										$num++;
									}
						...
						<tfoot>
							<tr>
								<td align="center" style="border-right:1px solid;border-top:1px solid;border-top:1px solid;border-top:1px solid;" colspan="5">รวม</td>
