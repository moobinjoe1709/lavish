	...
	<div class="page-header page-header-default">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">รายงานลูกค้า</span></h4>
			</div>
		...
		<div class="breadcrumb-line">
			<ul class="breadcrumb">
				...
				<li class="active">รายงานลูกค้า</li>
			</ul>
		</div>
	</div>
	<!-- /page header -->
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12">
									<fieldset>
										<legend class="text-semibold"><i class="icon-stack2"></i> รายงานลูกค้า</legend>
										<form id="myForm" method="post" action="{{url('customerpdf')}}" target="_blank">
										{{ csrf_field() }}
										<div class="row">
											<div class="col-md-2">
												<label>เซลล์ :</label>
												<select class="select-search" name="customer" id="customer">
...
<script>
			...
			'success': function (data){
				...
				$.each(data,function(key,item){
					...
					text += '<tr class="rowbody">'
						...
						+'<td align="right">'+formatNumber(item.order_qty)+'</td>'
	...
	$('#excel').click(function(){
		...
		window.open('{{url("customerexcel")}}/'+starts+'/'+ends+'/'+customer+'_blank');
	});
</script>
</html>
@stop