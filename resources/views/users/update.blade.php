	...
	<div class="page-header page-header-default">
		...
		<div class="breadcrumb-line">
			<ul class="breadcrumb">
				...
				<li><a href="{{url('bill')}}">ผู้ใช้งาน</a></li>
		...
		<!-- 2 columns form -->
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title">แก้ไขผู้ใช้งาน </h5>
				...
				<form method="post" action="{{url('users_update')}}" onsubmit="return check();">
				{{ csrf_field() }}
						...
						<div class="col-md-6 col-md-6 col-md-offset-3">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="input-control">
										<input type="text" class="form-control number" name="tel" id="tel" value="{{$users->phone}}" maxlength="10" required>
									</div>
								</div>
								<div class="form-group">
									<label>สถานะ :</label>
									<div class="input-control">
										<select class="form-control" name="status">
											<option value="0" @php if($users->status == 0){ @endphp selected @php} @endphp>พนักงาน</option>
											<option value="1" @php if($users->status == 1){ @endphp selected @php} @endphp>ผู้ดูแลระบบ</option>
										</select>
									</div>
								</div>
								<div class="form-group">
