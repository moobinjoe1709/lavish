				...
				<!-- Double border styling -->
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">คืนสินค้า</h5>
						...
						<div class="panel-body">
							<div class="pull-right">
								<a href="{{url('return/create')}}"<button type="button" class="btn btn-success btn-lg"><i class="icon-plus-circle2"></i> เพิ่ม</button></a>
							</div>
						</div>
